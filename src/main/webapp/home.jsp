...
<div class="row  border-bottom white-bg dashboard-header">
  <div class="col-sm-12">
    <blockquote class="text-warning" style="font-size:14px">
      基于Servlet+JSP实现的图书管理系统
      <br>Servlet+JSP从0到1实现…
      <br>数据库使用MySQL…
...
<%--    <br>--%>
<%--    <!-- <p>--%>
<%--        <a class="btn btn-success btn-outline" href="../../../wpa.qq.com/msgrd@v=3&uin=516477188&site=qq&menu=yes" target="_blank">--%>
<%--            <i class="fa fa-qq"> </i> 联系我--%>
<%--        </a>--%>
<%--        <a class="btn btn-white btn-bitbucket" href="../../default.htm" target="_blank">--%>
...
<%--          </div>--%>
<%--          <div class="ibox-content">--%>
<%--              <p><i class="fa fa-send-o"></i> 博客：<a href="../../default.htm" target="_blank">http://www.zi-han.net</a>--%>
<%--              </p>--%>
<%--              <p><i class="fa fa-qq"></i> QQ：<a href="../../../wpa.qq.com/msgrd@v=3&uin=516477188&site=qq&menu=yes" target="_blank">516477188</a>--%>
<%--              </p>--%>
